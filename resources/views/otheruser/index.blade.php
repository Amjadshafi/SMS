    ...
    <div class="modal-content">
      ...
      <form method="POST" action="{{route('update.complaint')}}">
        <div class="modal-body">
          ...
          @if(auth()->check() && auth()->user()->can('update_complaints'))
          <input type="text" name="assigned_to" id="assigned_to" class="form-control" readonly>
          @else
          <input type="text" name="assigned_to" id="assigned_to" class="form-control" readonly value="{{ auth()->user()->name }}">
          @endif
